...
<Cards>
  ...
  <Card title="Build a Viewer" href="/docs/guides/viewing">
    Understand pdf.js internals and study the custom viewer added to this repo
  </Card>
  <Card title="Viewer Without pdf.js" href="/docs/guides/viewing-without-pdfjs">
    Study the separate LibPDF-only viewer that reconstructs pages from extracted geometry
  </Card>
</Cards>
